...
public final class ExtensionLoader<T> {
    ...
    private static final String LEE_DIRECTORY = "META-INF/lee/";
    private static final String LEE_DIRECTORY_EXTERNAL = "META-INF/lee/external/";
    private static final String LEE_DIRECTORY_INTERNAL = "META-INF/lee/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            LEE_DIRECTORY,
            LEE_DIRECTORY_EXTERNAL,
            LEE_DIRECTORY_INTERNAL
    };
